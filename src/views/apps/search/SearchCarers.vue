<!-- =========================================================================================
  File Name: SearchCarers.vue
  Description: Search Kynd Carers
========================================================================================== -->
<!--   
  This is in place to fix the 'currentRefinement' v-model error.
  I will investigate this when we use this component.
-->
<!--  eslint-disable -->
<template>
  <div>
      ...
      <div class="algolia-header mb-4">
        <div class="flex md:items-end items-center justify-between flex-wrap">
          ...
          <div class="flex justify-between items-end flex-grow">
            ...
            <ais-stats>
              <p
                slot-scope="{ hitsPerPage, nbPages, nbHits, page, processingTimeMS }"
      ...
      >
        ...
        >
          <div class="p-6 filter-container">
            ...
            <!-- PRICE SLIDER -->
            <h6 class="font-bold mb-3">Distance from you (km)</h6>
                      ...
                      <template slot="action-buttons">
                        <div class="flex flex-wrap">
                          ...
                          <div
                            ...
                            @click="toggleItemInShortList(item)"
                          >
                            <feather-icon
                              icon="HeartIcon"
                              :svgClasses="[{'text-danger fill-current' : isInShortList(item.objectID)}, 'h-4 w-4']"
                            />

                            <span class="text-sm font-semibold ml-2">SAVE CARER</span>
                          </div>
...
export default {
  ...
  data() {
    return {
      /**
       * algoliasearch('ALGOLIA_APP_ID', 'ALGOLIA_SEARCH_ONLY_API_KEY')
       */
